...
| Command | Description |
|---|---|
| `/deathsound volume <0-100>` | Set death sound volume (0 = silent, 100 = full) |
| `/deathsound volume` | Show current volume |

## Contributors

- [nrxg](https://github.com/realnrxg)
